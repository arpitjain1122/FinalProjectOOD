...
public class DatabaseDriver {
	...
	public DatabaseDriver() {
		try {
			this.conn = DriverManager
					.getConnection("jdbc:sqlite:C:\\Arpit Files\\Local Disk D\\FinalProjectOOD\\symphonybank.db");
	...
	public ResultSet getTransactions(String pAddress, int limit) {
		...
		try {
			statement = this.conn.createStatement();
			resultSet = statement.executeQuery("SELECT * FROM Transactions WHERE Sender='" + pAddress
					+ "' OR Receiver='" + pAddress + "' LIMIT " + limit + ";");
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return resultSet;
	...
	public void newTransaction(String sender, String receiver, double amount, String message) {
		...
		try {
			...
			statement.executeUpdate(
					"INSERT INTO " + "Transactions(Sender, Receiver, Amount, Date, Message) " + "VALUES ('" + sender
							+ "', '" + receiver + "', " + amount + ", '" + date + "', '" + message + "');");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
	...
	public void createClient(String fName, String lName, String pAddress, String password, LocalDate date) {
		...
		try {
			...
			statement.executeUpdate("INSERT INTO " + "Clients (FirstName, LastName, PayeeAddress, Password, Date)"
					+ "VALUES ('" + fName + "', '" + lName + "', '" + pAddress + "', '" + password + "', '"
					+ date.toString() + "');");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	...
	public void createCheckingAccount(String owner, String number, double tLimit, double balance) {
		...
		try {
			statement = this.conn.createStatement();
			statement
					.executeUpdate("INSERT INTO " + "CheckingAccounts (Owner, AccountNumber, TransactionLimit, Balance)"
...
public class DatabaseDriver {
	...
	public DatabaseDriver() {
		try {
			this.conn = DriverManager
					.getConnection("jdbc:sqlite:C:\\Arpit Files\\Local Disk D\\FinalProjectOOD\\mazebank.db");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
